...
EXTRACTION_FIELDS: tuple[ExtractField, ...] = (
    ...
    ExtractField("drawing.exposition_class", "Exposition class", "drawing", "Exposure class (XC/XD/XS)", "scalar"),
    ExtractField("drawing.exposition_classes", "Exposition classes (all)", "drawing", "Every exposure class named in the title block", "list"),
